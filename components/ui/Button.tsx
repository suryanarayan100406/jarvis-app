...
// Export styles for external use (e.g. Links that look like buttons)
export const buttonVariants = (variant: "default" | "destructive" | "outline" | "secondary" | "ghost" | "link" | "neon" = "default", size: "default" | "sm" | "lg" | "icon" = "default") => {
